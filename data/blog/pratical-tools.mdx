---
title: "实用工具大全：助力学习与工作的利器集合"
date: "2023-10-20"
tags: ["工具"]
summary: "本篇汇总了各类实用工具，涵盖了科研、QT、AWS、搜索、文献、下载、设计、编程等多个领域。不论你是学生、工程师、科研人员还是设计师，都能在这里找到适合自己的工具。这些工具能够提高工作效率、辅助学习、解决问题，是学习与工作中的得力助手。"
---

## 科研

- [CS自学指南](https://csdiy.wiki/): 这是一本计算机的自学指南.
- [李沐《动手学深度学习》](https://zh-v2.d2l.ai/): 面向中文读者的能运行、可讨论的深度学习教科书.
- [李宏毅](https://speech.ee.ntu.edu.tw/~hylee/index.php): 台湾大学教授

## QT

- [使用QSS美化PyQt界面](https://muzing.top/posts/28a1d80f/): 使用QSS美化PyQt界面
